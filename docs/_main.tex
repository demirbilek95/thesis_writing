...
For applying BP and DFA in a more realistic setting, experiments are performed on the MNIST dataset by imitating the parity learning problem as it is described in \cite{DBLP:journals/corr/abs-2002-07400}. After putting DFA to this frame, the reason behind the results is interpreted, and possible improvements are motivated and implemented.\\
...
\caption{Reproduced MNIST Parity Experiment \cite{DBLP:journals/corr/abs-2002-07400}}\label{fig:MNISTparity}
\end{figure}
