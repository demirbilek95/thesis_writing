...
TODO: Write how this data is generated, why it's interesting, and why it is suitable for testing the learning dynamics of the methods.
...
{\centering \includegraphics[width=1\linewidth]{figures/BPvsDFA_SGD} 
...
{\centering \includegraphics[width=1\linewidth]{figures/DFA_50epochs} 
...
{\centering \includegraphics[width=1\linewidth]{figures/DFARandomMatrices} 
...
{\centering \includegraphics[width=1\linewidth]{figures/mainExperiment} 
...
{\centering \includegraphics[width=0.6\linewidth]{figures/hidden_rep_process} 
...
{\centering \includegraphics[width=1\linewidth]{figures/tsne_BPDFA} 
