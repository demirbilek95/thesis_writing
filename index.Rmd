...
#####################
title: |
  Dynamics of Learning Beyond Stochastic Gradient Descent \
author: Dogan Can Demirbilek
#college: Your College
university: University of Trieste
university-logo: figures/logo.jpeg
...
alternative-title-page: templates/alternative_cover.tex
...
use-biblatex: true
bib-latex-options: "style=numeric-comp, sorting=none"
# "style=authoryear, sorting=nyt, backend=biber, maxcitenames=2, useprefix, doi=true, isbn=false, uniquename=false" #for science, you might want style=numeric-comp, sorting=none for numerical in-text citation with references in order of appearance
